                    ...
                    <div>
                        <ul className="majorbtns">
                            ...
                            <li
                                className="aws"
                            >
                                <Link to="/services/digitaltransformation" className="majortext">
                            ...
                            <li
                                className="aws"
                            >
                                <Link to="/services/enterprisemobility" className="majortext">
                                Enterprise Mobility
                                        </Link>
                            </li>
                            <li
                                className="aws"
                            >
                                <Link to="/services/analytics" className="majortext">
