                    ...
                    <div>
                        <ul className="majorbtns">
                            ...
                            <li
                                className="aws"
                            >
                                <Link to="/services/ecommercedevelopment" className="majortext">
                                    Ecommerce <br />
                                            developement
                                        </Link>
                            </li> 
                            <li
                                className="aws"
                            >
                                <Link to="/services/arvr" className="majortext">
                                    AR / VR
                                        </Link>
                            </li>
                            <li
                                className="aws"
                            >
                                <Link to="/services/ecommerceintegration" className="majortext">
                                    Ecommerce <br />
                                            Integration
                                        </Link>
                            </li>
